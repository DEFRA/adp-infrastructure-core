...
try {
    ...
    az deployment group create -g SSVCDOINFRG3401 --template-file '/Users/asad.arif/gitrepos/adp-infrastructure/infra/observability/testarray.bicep' `
    --parameters azureMonitorWorkspaceResourceIds=$linkedWorkspacesJson
