...
param nsgList = [
  {
    nsg1name: '#{{ ssvResourceNamePrefix }}#{{ subEnvironment1 }}#{{ nc_resource_nsg }}#{{ nc_instance_regionid }}01'
    nsg2name: '#{{ ssvResourceNamePrefix }}#{{ subEnvironment2 }}#{{ nc_resource_nsg }}#{{ nc_instance_regionid }}01'
