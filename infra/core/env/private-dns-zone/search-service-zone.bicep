...
var privateDnsZoneName = toLower('${privateDnsZonePrefix}.privatelink.search.windows.net')
var commonTags = {
  Location: location
...
var dnsVnetLinksTags = {
  Name: vnet.name
  Purpose: 'Search Service Private DNS Zone VNet Link'
}

module privateDnsZoneModule 'br/SharedDefraRegistry:network.private-dns-zone:0.5.2' = {
  name: 'ssv-private-dns-zone-${deploymentDate}'
  params: {
   name: privateDnsZoneName  
   lock: 'CanNotDelete'
