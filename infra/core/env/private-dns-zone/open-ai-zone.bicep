...
var privateDnsZoneName = toLower('${privateDnsZonePrefix}.privatelink.openai.azure.com')
var commonTags = {
  Location: location
...
var dnsTags = {
  ...
  Purpose: 'Open AI Private DNS Zone'
}
var dnsVnetLinksTags = {
  Name: vnet.name
  Purpose: 'Open AI Private DNS Zone VNet Link'
}

module privateDnsZoneModule 'br/SharedDefraRegistry:network.private-dns-zone:0.5.2' = {
  name: 'oai-private-dns-zone-${deploymentDate}'
  params: {
   name: privateDnsZoneName  
   lock: 'CanNotDelete'
